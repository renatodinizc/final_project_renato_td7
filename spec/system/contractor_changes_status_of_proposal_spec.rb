...
describe 'Contractor changes status of proposal' do
  it 'to approved successfully' do
    ...
    website = Project.create!(title: 'Website para grupo de estudos',
                              ...
                              freelancer_expertise: webdev)
    create(:proposal, proposal_description: 'Quero ajudar a construir a liberdade',
  ...
  it 'to denied successfully' do
    ...
    fill_in 'Motivo',
            with: 'Tempo hábil de finalização do projeto não é o ideal'
    click_on 'Enviar feedback'

    expect(page).to have_content 'Status da proposta: Recusada'
    expect(page).to have_content 'Motivo: Tempo hábil de finalização do projeto não é o ideal'
