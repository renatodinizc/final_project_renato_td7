...
describe 'Visitor sees project details' do
  it 'successfully' do
    create(:project, title: 'Website para grupo de estudos', description: 'Grupo de estudos liberal de Salvador',
          desired_skills: 'Orientado a prazos e qualidade', top_hourly_wage: 33,
          proposal_deadline: 3.weeks.from_now, remote: true)
  ...
  it 'and comes back to see another project details successfully' do
    create(:project, title: 'Website para grupo de estudos', description: 'Grupo de estudos liberal de Salvador',
          desired_skills: 'Orientado a prazos e qualidade', top_hourly_wage: 33,
          proposal_deadline: 3.weeks.from_now, remote: true)
    create(:project, title: 'Artes impressas para palestra', description: 'Campeonato de debates na USP',
          desired_skills: 'Pessoa criativa e dinâmica', top_hourly_wage: 45,
          proposal_deadline: 4.weeks.from_now, remote: false)
