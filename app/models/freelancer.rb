class Freelancer < ApplicationRecord
  ...
  validates :full_name, :social_name, :birth_date, :degree, :description, :experience,
            :freelancer_expertise, presence: true, on: :profile_completion
  ...
  def check_if_underage
    ...
    errors.add(:birth_date,
               "deve ser anterior a #{I18n.l 18.years.ago}")
  end
end
